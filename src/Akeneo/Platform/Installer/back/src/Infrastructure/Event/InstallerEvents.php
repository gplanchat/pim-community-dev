...
final class InstallerEvents
{
     ...
     */
    const string POST_DB_CREATE = 'pim_installer.post_db_create';

    /**
     * This event is dispatched before launching any assets dump command
     */
    const string PRE_ASSETS_DUMP = 'pim_installer.pre_assets_dump';

    /**
     * This event is dispatched after launching all assets dump command
     */
    const string POST_ASSETS_DUMP = 'pim_installer.post_assets_dump';

    /**
     * This event is dispatched after launching all assets dump command
     */
    const string POST_SYMFONY_ASSETS_DUMP = 'pim_installer.post_symfony_assets_dump';
     ...
     */
    const string PRE_LOAD_FIXTURE = 'pim_installer.pre_load_fixture';
     ...
     * Symfony\Component\EventDispatcher\GenericEvent instance containing the job profile code.
     */
    const string POST_LOAD_FIXTURE = 'pim_installer.post_load_fixture';

    /**
     * This event is dispatched before any fixture has been loaded.
     */
    const string PRE_LOAD_FIXTURES = 'pim_installer.pre_load_fixtures';

    /**
     * This event is dispatched after when all fixtures are loaded.
     */
    const string POST_LOAD_FIXTURES = 'pim_installer.post_load_fixtures';

    /**
     * This event is dispatched before the instance has been reset.
     */
    const string PRE_RESET_INSTANCE = 'pim_installer.pre_reset_instance';

    /**
     * This event is dispatched after the instance has been reset.
     */
    const string POST_RESET_INSTANCE = 'pim_installer.post_reset_instance';
}
